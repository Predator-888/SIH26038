...
- **`dr_grading_inference.m`**: Loads `ml/checkpoints/idrid_grading_model.onnx` into MATLAB's Deep Learning Toolbox via `importNetworkFromONNX`, computes calibrated 5-class probabilities ($T=1.35$), and synthesizes Grad-CAM saliency heatmaps.
